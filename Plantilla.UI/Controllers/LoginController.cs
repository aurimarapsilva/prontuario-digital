...
namespace Plantilla.UI.Controllers
{
    public class LoginController : Controller
    {
        ...
        //Consultar roles
        public JsonResult ConsultarEsAdminPlantilla()
        {
            try
            {
                //Acceso a servicios
                ...
                else
                {
                    ...
                    int codRolAdminPlantilla = int.Parse(ConfigurationManager.AppSettings["CodRolAdim"].ToString());
                    foreach (var itm in respuesta.ObjetoRespuesta)
                    {
                        if (itm.IdRol == codRolAdminPlantilla)
                        {
