...
namespace Plantilla.Datos
{
    ...
    public partial class ProntuarioDigitalEntities : DbContext
    {
        ...
        public virtual int usp_CollegeDegreeDocumentsInsert(Nullable<int> genericDocumentId, string collegeDegreeType, Nullable<int> year, string institution, string country)
        {
            var genericDocumentIdParameter = genericDocumentId.HasValue ?
                new ObjectParameter("GenericDocumentId", genericDocumentId) :
                new ObjectParameter("GenericDocumentId", typeof(int));
    
            var collegeDegreeTypeParameter = collegeDegreeType != null ?
                new ObjectParameter("CollegeDegreeType", collegeDegreeType) :
                new ObjectParameter("CollegeDegreeType", typeof(string));
        ...
        public virtual ObjectResult<usp_GenericDocumentInsert_Result> usp_GenericDocumentInsert(Nullable<int> regulationId, Nullable<int> tipsId, string name)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GenericDocumentInsert_Result>("usp_GenericDocumentInsert", regulationIdParameter, tipsIdParameter, nameParameter);
        }
    
        public virtual ObjectResult<usp_GenericDocumentInsertUpdate_Result> usp_GenericDocumentInsertUpdate(Nullable<int> consecutive, Nullable<int> regulationId, Nullable<int> tipsId, Nullable<System.DateTime> created, string name)
        {
            var consecutiveParameter = consecutive.HasValue ?
                new ObjectParameter("Consecutive", consecutive) :
                new ObjectParameter("Consecutive", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GenericDocumentInsertUpdate_Result>("usp_GenericDocumentInsertUpdate", consecutiveParameter, regulationIdParameter, tipsIdParameter, createdParameter, nameParameter);
        }
        ...
        public virtual ObjectResult<usp_CollegeDegreeDocumentsGet_Result> usp_CollegeDegreeDocumentsGet()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_CollegeDegreeDocumentsGet_Result>("usp_CollegeDegreeDocumentsGet");
        }
    
        public virtual ObjectResult<usp_PresentationsGet_Result> usp_PresentationsGet()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_PresentationsGet_Result>("usp_PresentationsGet");
        }
    
        public virtual ObjectResult<usp_ResearchProjectGet_Result> usp_ResearchProjectGet()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_ResearchProjectGet_Result>("usp_ResearchProjectGet");
        }
    
        public virtual ObjectResult<usp_TrainingGet_Result> usp_TrainingGet()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_TrainingGet_Result>("usp_TrainingGet");
        }
    }
}
