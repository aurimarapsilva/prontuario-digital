using Plantilla.UIProcess.WCF_Seguridad;
using Plantilla.UIProcess.WCF_ServicioPlantilla;
using System;
using System.Collections.Generic;
using System.Configuration;


namespace Plantilla.UIProcess.Clases
{
    public class AccesoSeguridad
    {
        ...
        //WCF_Plantilla.PlantillaAPIClient WCF_Plantilla = new UIProcess.WCF_Plantilla.PlantillaAPIClient();
        WCF_Seguridad.TEC_Credenciales SegCredenciales = new TEC_Credenciales();
        WCF_ServicioPlantilla.ServiciosPlantillaClient WCF_ServiciosPlantilla = new ServiciosPlantillaClient();
        ...
        {
            return WCF_ServiciosPlantilla.ConsultarConfiguracion(idConfiguracion);
        }
